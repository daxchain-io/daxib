...
// analogue of String/MarshalJSON; `mcp serve` (structured slog to stderr)
// relies on it.
...
// contract: fmt.Stringer, fmt.GoStringer, json.Marshaler, and slog.LogValuer. A
// future refactor that drops one (e.g. a value-receiver MarshalJSON or a renamed
// String) is then a compile error, not a silent redaction hole.
var (
	_ fmt.Stringer   = (*Bytes)(nil)
	_ fmt.GoStringer = (*Bytes)(nil)
