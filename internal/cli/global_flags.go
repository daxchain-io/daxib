...
type FlagValues struct {
	...
	Network  string // --network: default-network override (mainnet/testnet/signet/regtest)
	Backend  string // --backend: per-invocation backend-endpoint override (bitcoind RPC / Electrum / Esplora)
