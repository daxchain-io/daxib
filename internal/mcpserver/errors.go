...
// tools — and these are thin forwards so the core and its tools subpackage cannot
// drift.
//
...
//	dualSignal  — true for the tx.wait_timeout code that needs BOTH IsError:true AND
//	              the structured *domain.TxResult.
